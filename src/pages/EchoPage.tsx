  ...
  return (
    <div className="relative z-20 w-full max-w-md mx-auto">
      ...
      <div className="flex justify-center mb-6">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full p-1 shadow-lg">
          <button
      ...
      {/* About Card */}
      {activeTab === 'about' && (
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700">
          {/* Logo and Title */}
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
              EchoNote converts your voice into accurate, formatted text with AI-powered transcription. Perfect for notes, documents, and creative writing. Join our waitlist for early access.
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-32 bg-transparent border border-gray-300 dark:border-gray-600 rounded-full text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
              />
              <button
                onClick={handleJoinWaitlist}
                className="absolute right-1 top-1 bottom-1 bg-black dark:bg-white text-white dark:text-black px-6 font-medium hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors rounded-full"
              >
                Join waitlist
              </button>
            </div>
